							...
							array(
								'cart_discount_apply_method' => array(
									...
									'options' => array(
										...
										'max'   => __( 'Apply maximum discount', 'easy-woocommerce-discounts' ) . ' - ' . __( 'Pro Version', 'easy-woocommerce-discounts' ),
										'min'   => __( 'Apply minimum discount', 'easy-woocommerce-discounts' ) . ' - ' . __( 'Pro Version', 'easy-woocommerce-discounts' ),
										'sum'   => __( 'Apply sum of discounts', 'easy-woocommerce-discounts' ) . ' - ' . __( 'Pro Version', 'easy-woocommerce-discounts' ),
									),
								...
								'cart_discount_with_individual_coupons' => array(
									...
									'options' => array(
										...
										0 => __( 'No', 'easy-woocommerce-discounts' ) . ' - ' . __( 'Pro Version', 'easy-woocommerce-discounts' ),
									),
									'disabled_options' => array( 0, 1 )
								),
								...
								'cart_discount_display_multiple_discounts' => array(
									...
									'std'     => 'separate',
									'options' => array(
										'separate' => __( 'Display all discounts separately', 'easy-woocommerce-discounts' ) . ' - ' . __( 'Pro Version', 'easy-woocommerce-discounts' ),
							...
							array(
								'change_display_price' => array(
									...
									'options' => array(
										...
										'simple'         => __( 'Change with HTML - Include simple adjustments', 'easy-woocommerce-discounts' ) . ' - ' . __( 'Pro Version', 'easy-woocommerce-discounts' ),
										'simple_ex_html' => __( 'Change whithout HTML - Include simple adjustments', 'easy-woocommerce-discounts' ) . ' - ' . __( 'Pro Version', 'easy-woocommerce-discounts' ),
									),
									'disabled_options' => array( 'simple', 'simple_ex_html' ),
								),
								'sale_badge' => array(
									'id'      => 'sale_badge',
									...
									'options' => array(
										'simple' => array(
											'std'      => '1',
											'id'       => 'simple',
											'name'     => __( 'Show sale badge on simple pricing products.', 'easy-woocommerce-discounts' ) . ' - ' . __( 'Pro Version', 'easy-woocommerce-discounts' ),
											'disabled' => true,
										),
										'bulk' => array(
											'id'   => 'bulk',
								...
								'sale_badge_type' => array(
									...
									'options' => array(
										...
										'discount' => __( 'Discount', 'easy-woocommerce-discounts' ) . ' - ' . __( 'Pro Version', 'easy-woocommerce-discounts' ),
									),
									'disabled_options' => array( 'discount' ),
								),
								...
								'product_pricing_discount_apply_method' => array(
									...
									'disabled_options' => array( 'max', 'min', 'sum' ),
								),
						...
						'quantity-table' => apply_filters( 'wccs_settings_promotion_quantity_table_section',
							array(
								...
								'quantity_table_layout' => array(
									...
									'type'    => 'select',
									'std'     => 'bulk-pricing-table-vertical',
									'options' => array(
										'bulk-pricing-table-horizontal' => __( 'Horizontal', 'easy-woocommerce-discounts' ) . ' - ' . __( 'Pro Version', 'easy-woocommerce-discounts' ),
										'bulk-pricing-table-vertical'   => __( 'Vertical', 'easy-woocommerce-discounts' ),
									),
									'disabled_options' => array( 'bulk-pricing-table-horizontal' ),
								),
							)
						),
						...
						'total-discounts' => apply_filters( 'wccs_settings_promotion_total_discounts_section',
							array(
								...
								'total_discounts_position_cart' => array(
									...
									'options' => array(
										'woocommerce_cart_totals_before_order_total' => __( 'Before order total', 'easy-woocommerce-discounts' ) . ' - ' . __( 'Pro Version', 'easy-woocommerce-discounts' ),
										'woocommerce_cart_totals_after_order_total'  => __( 'After order total', 'easy-woocommerce-discounts' ) . ' - ' . __( 'Pro Version', 'easy-woocommerce-discounts' ),
										'none'                                       => __( 'None', 'easy-woocommerce-discounts' ),
									),
									'disabled_options' => array(
								...
								'total_discounts_position_checkout' => array(
									...
									'options' => array(
										'woocommerce_review_order_before_order_total' => __( 'Before order total', 'easy-woocommerce-discounts' ) . ' - ' . __( 'Pro Version', 'easy-woocommerce-discounts' ),
										'woocommerce_review_order_after_order_total'  => __( 'After order total', 'easy-woocommerce-discounts' ) . ' - ' . __( 'Pro Version', 'easy-woocommerce-discounts' ),
										'none'                                        => __( 'None', 'easy-woocommerce-discounts' ),
									),
									'disabled_options' => array(
